...
const SettingsPage = () => {
  ...
  // Log when component mounts to verify current theme
  useEffect(() => {
    console.log("Settings page mounted with theme:", theme);
  }, [theme]);
    ...
    <div className="h-screen container mx-auto px-4 pt-20 max-w-5xl">
      <div className="space-y-6">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-base-content/70">Current theme: {theme}</p>
        </div>
